...
ALTER TABLE rawindex DROP COLUMN bookid, DROP COLUMN chapter, DROP COLUMN paraid, DROP COLUMN sentid, DROP COLUMN punc, DROP COLUMN italic, DROP COLUMN cparen,DROP COLUMN oparen, DROP COLUMN placeid, DROP COLUMN syllables, DROP COLUMN personid, DROP COLUMN runcharlength DROP COLUMN yearnum;
